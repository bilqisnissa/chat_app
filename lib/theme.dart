...
Color primaryColor = Color(0xff29CB9E);
Color greyColor = Color(0xffEBEFF3);
Color greyScreenColor = Color(0xffF8FAFC);
Color blackColor = Colors.black;
Color darkBlueColor = Color(0xff05233F);
Color darkGreyColor = Color(0xff505C6B);
...
TextStyle blueTextStyle = GoogleFonts.poppins(color: darkBlueColor);
